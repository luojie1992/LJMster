...
- (NSString *)uq_URLQueryStringWithPercentageEncoding:(BOOL)percentageEncoding {
  return [self uq_URLQueryStringWithSortedKeys:NO percentageEncoding:percentageEncoding];
}
...
- (NSString*)uq_URLQueryStringWithSortedKeys:(BOOL)sortedKeys percentageEncoding:(BOOL)percentageEncoding {
  ...
  return percentageEncoding ? [queryString uq_stringByPercentageEncodingWithReservedCharacters] : queryString;
}
