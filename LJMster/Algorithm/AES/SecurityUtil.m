...
#import "DZ_GTMBase64.h"
#import "NSData+AES.h"

#define Iv          @"ed16b1f8a9e6dgzq" //偏移量,可自行修改
#define KEY         @"ed16b1f8a9e6dgzq" //key，可自行修改
...
+ (NSString*)encodeBase64String:(NSString * )input { 
    ...
    data = [DZ_GTMBase64 encodeData:data]; 
...
+ (NSString*)decodeBase64String:(NSString * )input { 
    NSData *data = [input dataUsingEncoding:NSUTF8StringEncoding allowLossyConversion:YES]; 
    data = [DZ_GTMBase64 decodeData:data]; 
    NSString *base64String = [[NSString alloc] initWithData:data encoding:NSUTF8StringEncoding];
	return base64String;
} 
...
{
    //base64解密
    NSData *decodeBase64Data=[DZ_GTMBase64 decodeString:string];
    //使用密码对data进行解密
